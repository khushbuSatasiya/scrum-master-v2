...
import { Box, Code, Flex, List, Modal, Paper, ThemeIcon, Text, Divider } from '@mantine/core';
import { IconChecklist } from '@tabler/icons-react';

import { formatDate, formatTime, getCheckInColor, getTotalWorkingHourColor } from 'shared/util/utility';
								...
								<Flex>
									<Flex>
										...
										<Text
											...
											ml={5}
											color={`${
												task.inTime ? getCheckInColor(task.inTime, DeadLine.CHECK_IN) : 'red'
											}`}
										>
