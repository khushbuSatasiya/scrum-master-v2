...
import { LEAVE_DURATION, LEAVE_TYPE, useStyles } from '../constants/requestConstants';
...
const LeaveForm: FC<ILeaveFormProps> = ({ isUpcomingLeave, isVacational, leaveDuration, setLeaveDuration, form }) => {
	...
	return (
		<Box>
			...
			{isVacational ? (
				...
				<Select {...commonSelectProps} data={[{ label: 'Paid', value: 'Paid' }]} value='Paid' />
			)}
