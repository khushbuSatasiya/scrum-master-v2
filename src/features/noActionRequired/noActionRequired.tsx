...
import { Box, Code, Divider, Flex, List, Paper, Text, ThemeIcon } from '@mantine/core';
...
const NoActionRequired: FC<IProps> = ({ actionTime, tasks, date, totalHours }) => {
	return (
		<Box mt={30}>
								...
								return (
									...
									>
										<Flex justify={'space-between'}>
											...
											<Flex>
												<Text fz={14} fw={600} color='#99A1B7'>
													Project Hours :
												</Text>
												<Text fz={14} fw={600} ml={5} color={'green'}>
