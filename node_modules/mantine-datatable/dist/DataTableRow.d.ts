...
export default function DataTableRow<T>({ record, recordIndex, columns, defaultColumnProps, defaultColumnRender, selectionVisible, selectionChecked, onSelectionChange, isRecordSelectable, getSelectionCheckboxProps, onClick, onCellClick, onContextMenu, expansion, customAttributes, className, style, sx, contextMenuVisible, leftShadowVisible, }: DataTableRowProps<T>): import("react/jsx-runtime").JSX.Element;
export {};
