...
export declare function useRowExpansion<T>({ rowExpansion, records, idAccessor, }: {
    ...
    collapseRow: (record: T) => void | undefined;
    collapseProps: import("./types").DataTableRowExpansionCollapseProps | undefined;
    content: (record: T, recordIndex: number) => () => import("react").ReactNode;
} | undefined;
