...
export default function DataTableRowMenu({ borderRadius, shadow, zIndex, y: desiredY, x: desiredX, onDestroy, children, }: DataTableRowMenuProps): import("react/jsx-runtime").JSX.Element;
export {};
